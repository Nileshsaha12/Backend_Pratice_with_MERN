...
const generateAccessandRefreshToken = async(userId) =>{
  try {
    ...
    throw new ApiError(500,"Something went wrong while generating refresg and access token")
  }
}
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(200, createdUser, "Users register successfully"));
});
...
const refreshAccessToken = asyncHandler(async(req,res) => {
 ...
 try {
   ...
   if(inComingRefreshToken !== user?.refreshToken){
     throw new ApiError(401,"Refrese token is expired or used")
   }
